...
/**
 * Módulo da Fase 3 (coleta real de pedidos do Mercado Livre — persistência e
 * sincronização; os KPIs entram num commit/etapa seguinte deste mesmo
 * módulo). Reusa o MESMO símbolo `ML_FETCH` já definido pelo módulo OAuth
